...
import type { DrawCmd } from '@/components/CategoryColumn.vue'
import DrawSidebar from '@/components/DrawSidebar.vue'
import type { Link } from '@/components/DrawSidebar.vue'
...
import { CATEGORIES, byCategory, cards, drawPool } from '@/lib/cards'
