...
<template>
  <div class="arch-scope">
    ...
    <RouterLink
      to="/"
      class="arch-back"
      title="返回 FIVE SENSES 首页"
    >‹ FIVE SENSES</RouterLink>
...
/* 返回首页的小药丸：避开右侧 thumb-index（宽 118px） */
.arch-back {
  position: fixed;
  top: 14px;
  left: 14px;
  ...
  padding: 6px 12px;
  border: 1.5px solid var(--line-strong, #171510);
  background: var(--paper, #faf7ea);
  color: var(--ink, #171510);
  font-family: var(--disp, 'Bahnschrift', sans-serif);
  font-size: 15px;
  letter-spacing: 0.12em;
  text-decoration: none;
  box-shadow: 3px 3px 0 rgba(23, 21, 16, 0.9);
}
.arch-back:hover {
  background: var(--ink, #171510);
  color: var(--yp, #f6d911);
}
</style>
